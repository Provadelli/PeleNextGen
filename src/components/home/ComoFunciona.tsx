      ...
      <div className="mx-auto max-w-[1400px] px-6 py-24 lg:px-10 lg:py-32">
        ...
        <ol className="mt-16 grid gap-y-12 lg:grid-cols-4 lg:gap-x-10">
          {ETAPAS.map((e, i) => (
            ...
            >
              <p aria-hidden="true" className="font-display text-4xl font-extrabold tracking-[-0.04em] text-foreground/45 sm:text-5xl transition-colors duration-500 group-hover:text-primary lg:text-6xl">
                {e.n}
              </p>
