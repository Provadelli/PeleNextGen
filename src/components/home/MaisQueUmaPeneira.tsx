import img from "@/assets/home/time-grupo.jpg";
...
export function MaisQueUmaPeneira() {
  ...
  return (
    <section id="proposito" className="surface-ink scroll-mt-16">
        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-8">
          <Reveal className="lg:col-span-4 lg:pt-10">
            ...
            <p className="mt-6 max-w-sm text-base leading-relaxed text-muted-foreground">
              Antes da avaliação existe o treino sozinho, o ônibus de madrugada, a chuteira
              remendada. Cada atleta chega com uma história — e uma única oportunidade pode ser o
              começo de um novo capítulo.
            </p>
            <p className="mt-5 max-w-sm text-sm leading-relaxed text-muted-foreground">
              Por isso a plataforma não termina no dia da peneira: o histórico de avaliações, a
              evolução das habilidades e os vídeos do atleta continuam vivos no perfil, prontos para
              o próximo olheiro.
            </p>
            <dl className="mt-10 grid grid-cols-2 gap-6 border-t border-border pt-6">
              {[
                ...
                <div key={a}>
                  <dt className="font-display text-xl font-extrabold text-primary">{a}</dt>
                  <dd className="mt-1 text-xs leading-relaxed text-muted-foreground">{b}</dd>
                </div>
              ))}
            </dl>
          </Reveal>
