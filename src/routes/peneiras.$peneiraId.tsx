                ...
                {inscrito ? (
                  ...
                  <>
                    ...
                    <Button
                      ...
                      className="inline-flex items-center justify-center gap-2 whitespace-normal text-center font-medium transition-all focus:outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background focus-visible:scale-[1.02] focus-visible:shadow-gold disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 bg-primary text-primary-foreground shadow hover:bg-primary/90 h-auto min-h-10 py-2 rounded-md px-4 sm:px-8 mt-5 w-full text-base sm:text-lg"
                      size="lg"
                      disabled={
                        enviando ||
