...
function PerfilAtletaPage() {
  ...
  if (profile.stats.gols) conquistas.push({ label: `${profile.stats.gols} Gols`, sub: "Marcados" });
  ...
  clubes
    .slice(0, 2)
    .forEach((c) => conquistas.push({ label: c.clube, sub: c.periodo ?? "Passagem" }));

  return (
    <AppLayout>
      <div className="mx-auto max-w-6xl space-y-6">
        {/* Header bar */}
        <Reveal immediate className="flex flex-wrap items-center justify-between gap-3">
          <div>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <div className="mt-5 grid w-full grid-cols-2 gap-2 sm:grid-cols-4 lg:grid-cols-2">
                  ...
                  <QuickStat
                    ...
                    label="Altura"
                    value={
                      profile.altura ? (profile.altura / 100).toFixed(2).replace(".", ",") : "—"
                    }
            ...
            <div className="mb-4 flex items-baseline justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  Auditoria completa das autoavaliações e validações feitas por clubes e
                  treinadores.
                </p>
              </div>
            </div>
